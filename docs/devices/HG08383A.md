...
## Notes
Power on and off 3 times to get into pairing mode. It might be best to disconnect the chain from the power adaptor instead of turning on and off at socket.
